            ...
            <form onSubmit={onSubmit} className="space-y-5">
                        ...
                        <div className="rounded-[22px] border border-slate-200/80 bg-slate-50/85 px-4 py-3">
                            <div className="space-y-2 text-xs text-slate-500">
                                <div className="flex items-center gap-2">
                                    <span className={`size-2 rounded-full ${passwordStrength.length ? 'bg-emerald-500' : 'bg-slate-300'}`} />
                                    <span>At least 6 characters</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className={`size-2 rounded-full ${passwordStrength.number ? 'bg-emerald-500' : 'bg-slate-300'}`} />
                ...
                <div className={`rounded-[22px] border px-4 py-4 transition-colors ${
                    ...
                    <label className="flex items-start gap-3 text-sm leading-6 text-slate-600">
                        ...
                        />
                        <span>
                            I agree to the <span className="font-semibold text-sky-700">Terms of Service</span> and <span className="font-semibold text-sky-700">Privacy Policy</span>.
                        </span>
                    </label>

                    {fieldErrors.terms && (
                        <p className="mt-2 pl-7 text-sm font-medium text-rose-600">
                            {fieldErrors.terms}
                        </p>
                    )}
                </div>
