                ...
                {!showWithdraw ? (
                    ...
                    <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => setShowWithdraw(false)} className="text-gray-400 hover:text-gray-600 text-lg cursor-pointer bg-transparent border-none dark:text-white/40 dark:hover:text-white/70">✕</button>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <button onClick={() => setShowWithdraw(false)} className="flex-1 py-3 bg-gray-100 text-gray-700 font-bold text-sm rounded-xl cursor-pointer border-none dark:bg-white/10 dark:text-white/70">Cancel</button>
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none">
                        {!withdrawals.length ? (
                            ...
                            <div key={w._id} className="flex items-center gap-3 px-4 py-3.5 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition dark:border-white/10 dark:hover:bg-white/[0.05]">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-gray-800 dark:text-white">{fmt(w.amount)} → {w.upiId}</p>
